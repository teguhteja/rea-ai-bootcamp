   Deploying Python Apps with Docker Compose – Mastering AI Bootcamp 
...
- [Deploying Python Apps with Docker Compose](#deploying-python-apps-with-docker-compose)
  - [On this page](#on-this-page)
- [Deploying Python Apps with Docker Compose](#deploying-python-apps-with-docker-compose-1)
  ...
  - [Scaling and Managing with Docker Compose](#scaling-and-managing-with-docker-compose)
  - [Managing Your Docker Containers](#managing-your-docker-containers)
...
*   `services`: This section is where you define your services (containers). In this example, you have one service called `web`.
...
*   `volumes`: The `.` refers to the current directory on your host machine, and `/code` is the path inside the container. This line is essentially syncing your host machine’s current directory with the `/code` directory inside the container.
